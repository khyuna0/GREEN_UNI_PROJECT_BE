...
public interface SubjectRepository extends CrudRepository<Subject,Long> {
	// 과목 insert
	public Long insert(SubjectFormDto subjectFormDto);
	 ...
	 * 제일 최근 강의 ID 조회
	 */
	public Long selectIdOrderById(SubjectFormDto subjectFormDto);
	...
	public ReadSyllabusDto selectSyllabusBySubjectId(Long subjectId);
	
	/**
	 * @author 서영
	 * 정원 >= 신청인원인 강의의 id 리스트
	 */
	public List<Long> selectIdByLessNumOfStudent();
	
	/**
	 * @author 서영
	 * 정원 < 신청인원인 강의의 id 리스트
	 */
	public List<Long> selectIdByMoreNumOfStudent();
