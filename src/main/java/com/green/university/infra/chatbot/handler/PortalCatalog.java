...
import com.green.university.infra.chatbot.dto.ChatLinkFormDto;
    ...
    private Map<ChatIntent, Topic> buildTopics() {
        ...
        List<Topic> list = List.of(
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("금학기 성적조회 바로가기", "/grade/current")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("학기별 성적조회 바로가기", "/grade/semester")),
                ...
                new Topic(
                        ...
                        "누계 성적 조회 안내",
                        List.of("포털 > 성적 > 누계 성적"),
                        List.of(new ChatLinkFormDto("누계 성적 바로가기", "/grade/total")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("공지사항 바로가기", "/notice")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("학사일정 바로가기", "/schedule")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("전체 강의 조회 바로가기", "/subject/list")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("강의 시간표 조회 바로가기", "/sugang/list")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("예비 수강 신청 바로가기", "/sugang/pre")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("수강 신청 바로가기", "/sugang")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("수강 신청 내역 바로가기", "/sugang/timetable")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("수강신청 기간 설정 바로가기", "/sugang/period")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("내 정보 조회 바로가기", "/user/info")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("비밀번호 변경 바로가기", "/user/update/password")),
                ...
                new Topic(
                        ...
                        "휴학 신청 안내",
                        List.of("포털 > MY > 휴학 신청"),
                        List.of(new ChatLinkFormDto("휴학 신청 바로가기", "/break/application")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("휴학 내역 바로가기", "/break/list")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("휴학 처리 바로가기", "/break/list/staff")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("등록금 내역 바로가기", "/tuition")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("등록금 고지서 바로가기", "/tuition/payment")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("고지서 생성/발송 바로가기", "/tuition/bill")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("교수 명단 조회 바로가기", "/professor/list")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("학생 명단 조회 바로가기", "/student/list")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("내 강의 조회 바로가기", "/professor/subject")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("내 강의 평가 바로가기", "/professor/evaluation")),
                ...
                new Topic(
                        ...
                        "단과대 등록 안내(관리자)",
                        List.of("포털 > 등록 > 단과 대학"),
                        List.of(new ChatLinkFormDto("단과대 등록 바로가기", "/admin/college")),
                ...
                new Topic(
                        ...
                        "학과 등록 안내(관리자)",
                        List.of("포털 > 등록 > 학과"),
                        List.of(new ChatLinkFormDto("학과 등록 바로가기", "/admin/department")),
                ...
                new Topic(
                        ...
                        "강의실 등록 안내(관리자)",
                        List.of("포털 > 등록 > 강의실"),
                        List.of(new ChatLinkFormDto("강의실 등록 바로가기", "/admin/room")),
                        List.of("강의실", "room")
                ),
                new Topic(
                        ...
                        "강의 등록 안내(관리자)",
                        List.of("포털 > 등록 > 강의"),
                        List.of(new ChatLinkFormDto("강의 등록 바로가기", "/admin/subject")),
                ...
                new Topic(
                        ...
                        List.of(new ChatLinkFormDto("단대별 등록금 바로가기", "/admin/colltuit")),
