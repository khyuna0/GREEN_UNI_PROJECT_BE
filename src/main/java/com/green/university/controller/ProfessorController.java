...
public class ProfessorController {
	...
	public String subjectStudentList(Model model, @PathVariable Long subjectId) {
	...
	public String updateStudentDetail(Model model, @PathVariable Long subjectId, @PathVariable Long studentId) {
	...
	public String updateStudentDetailProc(Model model, @PathVariable Long subjectId, @PathVariable Long studentId,
	...
	public String createSyllabus(Model model, @PathVariable Long subjectId) {
